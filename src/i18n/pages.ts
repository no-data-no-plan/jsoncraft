...
const homeI18n: Record<Lang, HomeI18n> = {
  en: {
    ...
    bottomCtaText: "No signup, no limits. Everything runs locally in your browser.",
    introParagraphs: [
...
const pages: Record<string, { en: PageSeo; es: PageSeo }> = {
  formatter: {
    en: {
      ...
      seoHeading: "Format, Prettify, Beautify & Validate JSON Online",
    ...
    es: {
      title: "Formateador JSON Online — JSON Formatter & Validator Gratis",
  ...
  diff: {
    en: {
      ...
      seoHeading: "JSON Diff & Comparator — Compare JSON Documents Side by Side",
  ...
  viewer: {
    en: {
      ...
      seoHeading: "JSON Tree Viewer & Explorer — Interactive JSON Visualizer",
  ...
  jsonpath: {
    en: {
      ...
      seoHeading: "JSONPath Tester, Evaluator & Online Playground",
    ...
    es: {
      ...
      seoHeading: "JSONPath Online — Tester, Evaluador y Probar Consultas",
  ...
  "json-to-yaml": {
    en: {
      ...
      seoHeading: "Convert JSON to YAML Online — json2yaml Converter",
  ...
  "csv-to-json": {
    en: {
      ...
      seoHeading: "CSV to JSON Online — Parse Spreadsheet Data (csv2json)",
    ...
    es: {
      title: "Convertir CSV a JSON Online — Convertidor de Hoja de Cálculo Gratis",
      ...
      seoHeading: "Convertir CSV a JSON Online — Convertidor de Datos Excel a JSON",
  ...
  "toml-to-json": {
    ...
    es: {
      ...
      seoBlockText: "Analiza archivos de configuraci\u00f3n TOML y conv\u00edertelos a JSON. Admite todas las caracter\u00edsticas de TOML incluyendo tablas, arrays de tablas, tablas en l\u00ednea y valores tipados.",
      seoFeatures: ["Soporte completo de TOML v1.0", "Tablas y arrays de tablas mapeados a objetos JSON", "Valores tipados conservados (cadenas, enteros, flotantes, booleanos, fechas)", "Mensajes de error claros para sintaxis TOML inv\u00e1lida"],
    },
  },
  regex: {
    en: {
      title: "Regex Tester & Visualizer \u2014 Test Regular Expressions Online Free",
      description: "Test a regex online in real time. Free regex tester with capture groups, all JS flags (g/i/m/s/u/y), match highlighting. Browser-based.",
      seoHeading: "Regex Tester, Validator & Builder — Test Regex Online",
    ...
    es: {
      title: "Tester de Regex y Visualizador — Probar Expresiones Regulares Online Gratis",
      description: "Probar regex online en tiempo real. Tester gratis con grupos de captura, todos los flags JS (g/i/m/s/u/y), resaltado de coincidencias.",
      seoHeading: "Probar Regex Online — Tester JavaScript y Validador de Expresión Regular",
  ...
  base64: {
    en: {
      ...
      seoHeading: "Base64 Encoder & Decoder Online — Encode/Decode Text & Files",
    ...
    es: {
      ...
      description: "Codifica texto a Base64 o decodifica cadenas Base64 instant\u00e1neamente. Conversor Base64 online gratuito \u2014 admite UTF-8, se ejecuta completamente en tu navegador.",
      seoHeading: "Base64 Online — Codificar y Decodificar Texto, Imagen y Archivos",
  ...
  "url-encode": {
    ...
    es: {
      ...
      description: "Codifica o decodifica URLs y cadenas de consulta para transmisi\u00f3n segura. Admite modos encodeURIComponent y encodeURI. Gratuito, privado, en el navegador.",
      ...
      seoBlockHeading: "Sobre esta herramienta",
      seoBlockText: "La codificaci\u00f3n de URL (codificaci\u00f3n porcentual) reemplaza caracteres inseguros con % seguido de dos d\u00edgitos hexadecimales. El modo Component codifica todos los caracteres especiales, mientras que el modo URI conserva caracteres como :, / y ? que son v\u00e1lidos en URLs.",
      seoFeatures: [
  ...
  "json-to-typescript": {
    en: {
      ...
      seoHeading: "JSON to TypeScript — Generate Interfaces & Types (json2ts)",
    ...
    es: {
      ...
      seoHeading: "JSON a TypeScript — Generar Interfaces y Tipos (json2ts)",
  ...
  "xml-formatter": {
    en: {
      ...
      description: "Format, prettify and minify XML online for free. Proper indentation, syntax validation, and one-click minification. Runs in your browser.",
    ...
    es: {
      ...
      description: "Formatea, embellece y minifica XML online gratis. Sangr\u00eda correcta, validaci\u00f3n de sintaxis y minificaci\u00f3n con un clic. En tu navegador.",
      seoHeading: "Formatea y Embellece XML al Instante",
      seoText: "Pega XML, arrastra un archivo o sube un documento .xml y el formateador lo analiza como DOM, valida que cada tag est\u00e9 bien formada y lo reescribe con sangr\u00eda uniforme usando espacios de 2 o 4. Un modo minify elimina cada car\u00e1cter de espacio en blanco no esencial para que el documento colapse a una sola l\u00ednea \u2014 \u00fatil para embeber XML como payload dentro de otro formato o minimizar tama\u00f1o de transferencia.\n\nEs la herramienta para hacer legible una respuesta SOAP, inspeccionar un archivo de configuraci\u00f3n (pom.xml, web.xml, .csproj), depurar un feed RSS o Atom, limpiar un sitemap o SVG antes de subir al repo, leer un layout Android pegado desde un bug report, o preparar un fixture XML para una suite de tests que espera texto diffable. Tambi\u00e9n sirve para revisar diferencias entre dos documentos XML una vez ambos est\u00e1n formateados de forma uniforme.\n\nLa buena formaci\u00f3n se exige: tags mal cerradas, elementos sin cerrar y entidades de car\u00e1cter inv\u00e1lidas generan cada una un mensaje de error espec\u00edfico apuntando a la l\u00ednea donde se rompi\u00f3 el parseo. El quoting de atributos se normaliza a comillas dobles, las secciones CDATA e instrucciones de procesamiento se conservan, y los comentarios XML pasan sin tocarse. Una vez formateado, el resultado se puede copiar o descargar como archivo .xml.\n\nEl parseo corre v\u00eda el DOMParser nativo del navegador \u2014 sin subida, sin servidor, sin tracking.",
  ...
  "yaml-validator": {
    en: {
      title: "YAML Validator Online Free — Validate YAML Syntax Instantly",
      description: "Validate YAML online free. Detailed syntax errors with line/column numbers, parsed JSON preview, multi-document support. Browser-based.",
    ...
    es: {
      title: "Validador YAML Online Gratis — Valida sintaxis YAML al instante",
      description: "Valida YAML online gratis. Errores de sintaxis con línea/columna, vista previa JSON analizada y soporte multi-documento. 100% en navegador.",
      seoHeading: "Validar YAML Online — Comprobador y Linter de Sintaxis",
      ...
      seoBlockText: "YAML es un formato de serializaci\u00f3n de datos legible por humanos usado para archivos de configuraci\u00f3n (Docker Compose, Kubernetes, CI/CD). Los errores de sintaxis en YAML pueden ser dif\u00edciles de detectar por la estructura basada en sangr\u00eda.",
      seoFeatures: [
        "Validaci\u00f3n en tiempo real mientras escribes",
