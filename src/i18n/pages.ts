...
const pages: Record<string, { en: PageSeo; es: PageSeo }> = {
  formatter: {
    ...
    es: {
      ...
      seoHeading: "Formatear, Embellecer y Validar JSON Online",
