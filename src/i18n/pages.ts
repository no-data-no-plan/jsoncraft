...
const pages: Record<string, { en: PageSeo; es: PageSeo }> = {
  ...
  "yaml-validator": {
    en: {
      ...
      description: "Validate YAML online free. Detailed syntax errors with line/column numbers, parsed JSON preview, multi-document support. Browser-based, 100% private.",
