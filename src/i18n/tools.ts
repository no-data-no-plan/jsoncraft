...
const urlEncode = {
  ...
  es: {
    ...
    form: "Formulario",
    modeHint: "Form: espacio \u2192 '+' (formularios HTML). URI: conserva estructura de URL. Component: codifica todo.",
...
const hash = {
  ...
  es: {
    ...
    md5FileUnsupported: "Hash MD5 de archivos no compatible \u2014 usa SHA-256",
    hashing: "Hasheando...",
...
const yamlValidator = {
  ...
  es: {
    ...
    outputPlaceholder: "La salida JSON analizada aparecer\u00e1 aqu\u00ed...",
