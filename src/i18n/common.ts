...
const common = {
  en: {
    ...
    closeDialog: "Close",
    shortcutsHint: "Press ? to open this dialog from anywhere on the site.",
    shortcutsCatActions: "Actions",
    shortcutsCatEditor: "Editor",
    shortcutsCatHelp: "Help",
    shortcutFormat: "Format JSON",
    shortcutEditorUndo: "Undo (in editor)",
    shortcutEditorRedo: "Redo (in editor)",
    shortcutEditorIndent: "Indent (Tab inside editor)",
    shortcutEditorOutdent: "Outdent (Shift+Tab inside editor)",
    shortcutEditorEscape: "Leave editor with keyboard",
  ...
  es: {
    ...
    shortcutsCatActions: "Acciones",
    shortcutsCatEditor: "Editor",
    shortcutsCatHelp: "Ayuda",
    shortcutFormat: "Formatear JSON",
    shortcutEditorUndo: "Deshacer (dentro del editor)",
    shortcutEditorRedo: "Rehacer (dentro del editor)",
    shortcutEditorIndent: "Indentar (Tab dentro del editor)",
    shortcutEditorOutdent: "Desindentar (Shift+Tab dentro del editor)",
    shortcutEditorEscape: "Salir del editor con teclado",
    shortcutOpenShortcuts: "Abrir este diálogo",
  },
} as const;
